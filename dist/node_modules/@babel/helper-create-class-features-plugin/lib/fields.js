...
function buildPrivateInstanceFieldInitSpec(ref, prop, privateNamesMap, state) {
  ...
  return inheritPropComments(_core.types.expressionStatement(_core.types.callExpression(helper, [_core.types.thisExpression(), _core.types.cloneNode(id), newHelpers(state) ? value : _core.template.expression.ast(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["{ writable: true, value: ", " }"])), value)])), prop);
}
...
function buildPrivateAccessorInitialization(ref, prop, privateNamesMap, state) {
  ...
  var helper = state.addHelper("classPrivateFieldInitSpec");
  return inheritPropComments(_core.template.statement.ast(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["", "(\n      ", ",\n      ", ",\n      {\n        get: ", ",\n        set: ", "\n      },\n    )"])), helper, _core.types.thisExpression(), _core.types.cloneNode(id), getId ? getId.name : prop.scope.buildUndefinedNode(), setId ? setId.name : prop.scope.buildUndefinedNode()), prop);
}
