...
function _traceMapping() {
  var data = require("@jridgewell/trace-mapping");
...
function _ref() {
  _ref = _asyncToGenerator(function (_ref2) {
    ...
    return /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
      var buildResult, countNewlines, output, readStdin, stdin, _stdin, walk, _walk, files, _files;
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          case 0:
            _files = function _files3() {
              _files = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(filenames) {
                  ...
                  while (1) switch (_context4.prev = _context4.next) {
                    ...
                    case 4:
                      if (cliOptions.watch) {
                        ...
                        watcher.onFilesChange(function (changes, event, cause) {
                          var actionableChange = changes.some(function (filename) {
                            return util.isCompilableExtension(filename, cliOptions.extensions) || filenames.includes(filename);
                          });
            ...
            files = function _files2(_x3) {
              return _files.apply(this, arguments);
            };
            _walk = function _walk3() {
              _walk = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(filenames) {
                ...
                return _regeneratorRuntime().wrap(function _callee3$(_context3) {
                  while (1) switch (_context3.prev = _context3.next) {
                    case 0:
                      ...
                      _context3.next = 4;
                      return Promise.all(_filenames.map(_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(filename) {
                        var sourceFilename;
                        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                          while (1) switch (_context2.prev = _context2.next) {
                            case 0:
                              ...
                              _context2.prev = 3;
                              _context2.next = 6;
                              return util.compile(filename, Object.assign({}, babelOptions, {
            ...
            walk = function _walk2(_x2) {
              return _walk.apply(this, arguments);
            };
            _stdin = function _stdin3() {
              _stdin = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
                var code, res;
                return _regeneratorRuntime().wrap(function _callee$(_context) {
                  while (1) switch (_context.prev = _context.next) {
                    ...
                    case 2:
                      code = _context.sent;
                      _context.next = 5;
                      return util.transformRepl(cliOptions.filename, code, Object.assign({}, babelOptions, {
            ...
            stdin = function _stdin2() {
              return _stdin.apply(this, arguments);
            };
            readStdin = function _readStdin() {
              return new Promise(function (resolve, reject) {
                var code = "";
            ...
            output = function _output(fileResults) {
              var result = buildResult(fileResults);
              if (cliOptions.outFile) {
                ((function (v, w) {
                  return v = v.split("."), w = w.split("."), +v[0] > +w[0] || v[0] == w[0] && +v[1] >= +w[1];
                })(process.versions.node, "10.12") ? _fs().mkdirSync : require("make-dir").sync)(_path().dirname(cliOptions.outFile), {
                  recursive: true
                });
                var outputMap = false;
            ...
            countNewlines = function _countNewlines(code) {
              var count = 0;
              var index = -1;
            ...
            buildResult = function _buildResult(fileResults) {
              var mapSections = [];
              var code = "";
              var offset = 0;
              var hasRawMap = false;
              var _iterator = _createForOfIteratorHelper(fileResults),
                _step;
              try {
              ...
              var map = new (_traceMapping().AnyMap)({
                version: 3,
