...
({});
var transformFileRunner = _gensync()( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(filename, opts) {
  ...
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) switch (_context.prev = _context.next) {
      case 0:
        ...
        return _context.delegateYield((0, _index["default"])(options), "t0", 2);
      case 2:
        config = _context.t0;
        if (!(config === null)) {
          _context.next = 5;
      ...
      case 6:
        code = _context.t1;
        return _context.delegateYield((0, _index2.run)(config, code), "t2", 8);
      case 8:
...
function transformFile() {
  transformFileRunner.errback.apply(transformFileRunner, arguments);
}
