...
var ConfigError = /*#__PURE__*/function (_Error) {
  function ConfigError(message, filename) {
    ...
    _this = _callSuper(this, ConfigError, [message]);
    (0, _rewriteStackTrace.expectedError)(_this);
    if (filename) (0, _rewriteStackTrace.injectVirtualStackFrame)(_this, filename);
    return _this;
  }
