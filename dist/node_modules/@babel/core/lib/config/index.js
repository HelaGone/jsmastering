...
var _marked = /*#__PURE__*/_regeneratorRuntime().mark(loadOptionsImpl);
...
function loadPartialConfigAsync() {
  return (0, _rewriteStackTrace.beginHiddenCallStack)(loadPartialConfigRunner.async).apply(void 0, arguments);
}
function loadPartialConfigSync() {
  return (0, _rewriteStackTrace.beginHiddenCallStack)(loadPartialConfigRunner.sync).apply(void 0, arguments);
}
...
function loadOptionsImpl(opts) {
  ...
  return _regeneratorRuntime().wrap(function loadOptionsImpl$(_context) {
...
function loadOptionsAsync() {
  return (0, _rewriteStackTrace.beginHiddenCallStack)(loadOptionsRunner.async).apply(void 0, arguments);
}
function loadOptionsSync() {
  return (0, _rewriteStackTrace.beginHiddenCallStack)(loadOptionsRunner.sync).apply(void 0, arguments);
}
...
function createConfigItemAsync() {
  return (0, _rewriteStackTrace.beginHiddenCallStack)(createConfigItemRunner.async).apply(void 0, arguments);
}
function createConfigItemSync() {
  return (0, _rewriteStackTrace.beginHiddenCallStack)(createConfigItemRunner.sync).apply(void 0, arguments);
}
