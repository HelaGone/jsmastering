  ...
  return _regeneratorRuntime().wrap(function normalizeFile$(_context) {
    while (1) switch (_context.prev = _context.next) {
      ...
      case 8:
        ...
        break;
      case 11:
        return _context.delegateYield((0, _index["default"])(pluginPasses, options, code), "t0", 12);
      case 12:
        ast = _context.t0;
      case 13:
        inputMap = null;
          ...
          if (!inputMap) {
            ...
            if (typeof options.filename === "string" && _lastComment) {
              try {
                ...
                inputMapContent = _fs().readFileSync(_path().resolve(_path().dirname(options.filename), match[1]), "utf8");
