...
var toNodeDescription = function toNodeDescription(_ref3) {
  var type = _ref3.type,
    prefix = _ref3.prefix;
  return type === "UpdateExpression" ? NodeDescriptions.UpdateExpression[String(prefix)] : NodeDescriptions[type];
};
var StandardErrors = {
  AccessorIsGenerator: function AccessorIsGenerator(_ref4) {
    var kind = _ref4.kind;
  ...
  DeclarationMissingInitializer: function DeclarationMissingInitializer(_ref5) {
    var kind = _ref5.kind;
  ...
  DuplicateExport: function DuplicateExport(_ref6) {
    var exportName = _ref6.exportName;
    return "`".concat(exportName, "` has already been exported. Exported identifiers must be unique.");
  },
  DuplicateProto: "Redefinition of __proto__ property.",
  DuplicateRegExpFlags: "Duplicate regular expression flag.",
  DynamicImportPhaseRequiresImportExpressions: function DynamicImportPhaseRequiresImportExpressions(_ref7) {
  ...
  ExportBindingIsString: function ExportBindingIsString(_ref8) {
    var localName = _ref8.localName,
      exportName = _ref8.exportName;
    return "A string literal cannot be used as an exported binding without `from`.\n- Did you mean `export { '".concat(localName, "' as '").concat(exportName, "' } from 'some-module'`?");
  },
  ExportDefaultFromAsIdentifier: "'from' is not allowed as an identifier after 'export default'.",
  ForInOfLoopInitializer: function ForInOfLoopInitializer(_ref9) {
    var type = _ref9.type;
  ...
  IllegalBreakContinue: function IllegalBreakContinue(_ref10) {
  ...
  ImportBindingIsString: function ImportBindingIsString(_ref11) {
    var importName = _ref11.importName;
    return "A string literal cannot be used as an imported binding.\n- Did you mean `import { \"".concat(importName, "\" as foo }`?");
  },
  ImportCallArgumentTrailingComma: "Trailing comma is disallowed inside import(...) arguments.",
  ImportCallArity: function ImportCallArity(_ref12) {
    var maxArgumentCount = _ref12.maxArgumentCount;
  ...
  InvalidDigit: function InvalidDigit(_ref13) {
    var radix = _ref13.radix;
    return "Expected number in radix ".concat(radix, ".");
  },
  InvalidEscapeSequence: "Bad character escape sequence.",
  InvalidEscapeSequenceTemplate: "Invalid escape sequence in template.",
  InvalidEscapedReservedWord: function InvalidEscapedReservedWord(_ref14) {
    var reservedWord = _ref14.reservedWord;
    return "Escape sequence in keyword ".concat(reservedWord, ".");
  },
  InvalidIdentifier: function InvalidIdentifier(_ref15) {
    var identifierName = _ref15.identifierName;
    return "Invalid identifier ".concat(identifierName, ".");
  },
  InvalidLhs: function InvalidLhs(_ref16) {
    var ancestor = _ref16.ancestor;
    return "Invalid left-hand side in ".concat(toNodeDescription(ancestor), ".");
  },
  InvalidLhsBinding: function InvalidLhsBinding(_ref17) {
    var ancestor = _ref17.ancestor;
    return "Binding invalid left-hand side in ".concat(toNodeDescription(ancestor), ".");
  },
  InvalidLhsOptionalChaining: function InvalidLhsOptionalChaining(_ref18) {
    var ancestor = _ref18.ancestor;
    return "Invalid optional chaining in the left-hand side of ".concat(toNodeDescription(ancestor), ".");
  },
  InvalidNumber: "Invalid number.",
  InvalidOrMissingExponent: "Floating-point numbers require a valid exponent after the 'e'.",
  InvalidOrUnexpectedToken: function InvalidOrUnexpectedToken(_ref19) {
    var unexpected = _ref19.unexpected;
    return "Unexpected character '".concat(unexpected, "'.");
  },
  InvalidParenthesizedAssignment: "Invalid parenthesized assignment pattern.",
  InvalidPrivateFieldResolution: function InvalidPrivateFieldResolution(_ref20) {
  ...
  LabelRedeclaration: function LabelRedeclaration(_ref21) {
    var labelName = _ref21.labelName;
  ...
  MissingPlugin: function MissingPlugin(_ref22) {
  ...
  MissingOneOfPlugins: function MissingOneOfPlugins(_ref23) {
    var missingPlugin = _ref23.missingPlugin;
  ...
  ModuleAttributesWithDuplicateKeys: function ModuleAttributesWithDuplicateKeys(_ref24) {
    var key = _ref24.key;
    return "Duplicate key \"".concat(key, "\" is not allowed in module attributes.");
  },
  ModuleExportNameHasLoneSurrogate: function ModuleExportNameHasLoneSurrogate(_ref25) {
    var surrogateCharCode = _ref25.surrogateCharCode;
    return "An export name cannot include a lone surrogate, found '\\u".concat(surrogateCharCode.toString(16), "'.");
  },
  ModuleExportUndefined: function ModuleExportUndefined(_ref26) {
    var localName = _ref26.localName;
  ...
  PrivateInExpectedIn: function PrivateInExpectedIn(_ref27) {
  ...
  PrivateNameRedeclaration: function PrivateNameRedeclaration(_ref28) {
  ...
  UnexpectedKeyword: function UnexpectedKeyword(_ref29) {
    var keyword = _ref29.keyword;
  ...
  UnexpectedReservedWord: function UnexpectedReservedWord(_ref30) {
    var reservedWord = _ref30.reservedWord;
    return "Unexpected reserved word '".concat(reservedWord, "'.");
  },
  UnexpectedSuper: "'super' is only allowed in object methods and classes.",
  UnexpectedToken: function UnexpectedToken(_ref31) {
    var expected = _ref31.expected,
      unexpected = _ref31.unexpected;
  ...
  UnsupportedMetaProperty: function UnsupportedMetaProperty(_ref32) {
    var target = _ref32.target,
      onlyValidPropertyName = _ref32.onlyValidPropertyName;
  ...
  VarRedeclaration: function VarRedeclaration(_ref33) {
    var identifierName = _ref33.identifierName;
...
var StrictModeErrors = {
  ...
  StrictEvalArguments: function StrictEvalArguments(_ref34) {
    var referenceName = _ref34.referenceName;
    return "Assigning to '".concat(referenceName, "' in strict mode.");
  },
  StrictEvalArgumentsBinding: function StrictEvalArgumentsBinding(_ref35) {
    var bindingName = _ref35.bindingName;
...
var PipelineOperatorErrors = {
  ...
  PipeTopicUnconfiguredToken: function PipeTopicUnconfiguredToken(_ref36) {
  ...
  PipeUnparenthesizedBody: function PipeUnparenthesizedBody(_ref37) {
...
var LValParser = /*#__PURE__*/function (_NodeUtils) {
  ...
  return _createClass(LValParser, [{
    ...
    key: "checkLVal",
    value: function checkLVal(expression, _ref66) {
      var ancestor = _ref66["in"],
        _ref66$binding = _ref66.binding,
        binding = _ref66$binding === void 0 ? 64 : _ref66$binding,
        _ref66$checkClashes = _ref66.checkClashes,
        checkClashes = _ref66$checkClashes === void 0 ? false : _ref66$checkClashes,
        _ref66$strictModeChan = _ref66.strictModeChanged,
        strictModeChanged = _ref66$strictModeChan === void 0 ? false : _ref66$strictModeChan,
        _ref66$hasParenthesiz = _ref66.hasParenthesizedAncestor,
        hasParenthesizedAncestor = _ref66$hasParenthesiz === void 0 ? false : _ref66$hasParenthesiz;
      ...
      var _ref67 = Array.isArray(validity) ? validity : [validity, type === "ParenthesizedExpression"],
        _ref68 = _slicedToArray(_ref67, 2),
        key = _ref68[0],
        isParenthesizedExpression = _ref68[1];
...
var TSErrors = ParseErrorEnum(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["typescript"])))({
  AbstractMethodHasImplementation: function AbstractMethodHasImplementation(_ref69) {
    var methodName = _ref69.methodName;
    return "Method '".concat(methodName, "' cannot have an implementation because it is marked abstract.");
  },
  AbstractPropertyHasInitializer: function AbstractPropertyHasInitializer(_ref70) {
    var propertyName = _ref70.propertyName;
  ...
  DeclareAccessor: function DeclareAccessor(_ref71) {
    var kind = _ref71.kind;
    return "'declare' is not allowed in ".concat(kind, "ters.");
  },
  DeclareClassFieldHasInitializer: "Initializers are not allowed in ambient contexts.",
  DeclareFunctionHasImplementation: "An implementation cannot be declared in ambient contexts.",
  DuplicateAccessibilityModifier: function DuplicateAccessibilityModifier(_ref72) {
    var modifier = _ref72.modifier;
    return "Accessibility modifier already seen.";
  },
  DuplicateModifier: function DuplicateModifier(_ref73) {
    var modifier = _ref73.modifier;
    return "Duplicate modifier: '".concat(modifier, "'.");
  },
  EmptyHeritageClauseType: function EmptyHeritageClauseType(_ref74) {
  ...
  IncompatibleModifiers: function IncompatibleModifiers(_ref75) {
    var modifiers = _ref75.modifiers;
    return "'".concat(modifiers[0], "' modifier cannot be used with '").concat(modifiers[1], "' modifier.");
  },
  IndexSignatureHasAbstract: "Index signatures cannot have the 'abstract' modifier.",
  IndexSignatureHasAccessibility: function IndexSignatureHasAccessibility(_ref76) {
  ...
  InvalidModifierOnTypeMember: function InvalidModifierOnTypeMember(_ref77) {
    var modifier = _ref77.modifier;
    return "'".concat(modifier, "' modifier cannot appear on a type member.");
  },
  InvalidModifierOnTypeParameter: function InvalidModifierOnTypeParameter(_ref78) {
    var modifier = _ref78.modifier;
    return "'".concat(modifier, "' modifier cannot appear on a type parameter.");
  },
  InvalidModifierOnTypeParameterPositions: function InvalidModifierOnTypeParameterPositions(_ref79) {
    var modifier = _ref79.modifier;
    return "'".concat(modifier, "' modifier can only appear on a type parameter of a class, interface or type alias.");
  },
  InvalidModifiersOrder: function InvalidModifiersOrder(_ref80) {
    var orderedModifiers = _ref80.orderedModifiers;
  ...
  PrivateElementHasAccessibility: function PrivateElementHasAccessibility(_ref81) {
  ...
  SingleTypeParameterWithoutTrailingComma: function SingleTypeParameterWithoutTrailingComma(_ref82) {
    var typeParameterName = _ref82.typeParameterName;
  ...
  UnsupportedSignatureParameterKind: function UnsupportedSignatureParameterKind(_ref83) {
...
var typescript = function typescript(superClass) {
  return /*#__PURE__*/function (_superClass4) {
    ...
    return _createClass(TypeScriptParserMixin, [{
      ...
      value: function tsParseModifiers(_ref84, modified) {
        var _this27 = this;
        var allowedModifiers = _ref84.allowedModifiers,
          disallowedModifiers = _ref84.disallowedModifiers,
          stopOnStartOfClassStaticBlock = _ref84.stopOnStartOfClassStaticBlock,
          _ref84$errorTemplate = _ref84.errorTemplate,
          errorTemplate = _ref84$errorTemplate === void 0 ? TSErrors.InvalidModifierOnTypeMember : _ref84$errorTemplate;
...
function hasPlugin(plugins, expectedConfig) {
  var _ref85 = typeof expectedConfig === "string" ? [expectedConfig, {}] : expectedConfig,
    _ref86 = _slicedToArray(_ref85, 2),
    expectedName = _ref86[0],
    expectedOptions = _ref86[1];
...
var StatementParser = /*#__PURE__*/function (_ExpressionParser) {
  ...
  return _createClass(StatementParser, [{
    ...
    value: function maybeParseExportNamedSpecifiers(node) {
      if (this.match(5)) {
        var _node$specifiers3;
        if (!node.specifiers) node.specifiers = [];
        var isTypeExport = node.exportKind === "type";
        (_node$specifiers3 = node.specifiers).push.apply(_node$specifiers3, _toConsumableArray(this.parseExportSpecifiers(isTypeExport)));
        node.source = null;
    ...
    value: function isJSONModuleImport(node) {
      if (node.assertions != null) {
        return node.assertions.some(function (_ref87) {
          var key = _ref87.key,
            value = _ref87.value;
...
function pluginsMap(plugins) {
  ...
  try {
    for (_iterator18.s(); !(_step18 = _iterator18.n()).done;) {
      ...
      var _ref88 = Array.isArray(plugin) ? plugin : [plugin, {}],
