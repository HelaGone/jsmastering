...
function traceMappings(tree) {
  ...
  var gen = new _genMapping.GenMapping({
    file: tree.map.file
  });
  var rootSources = tree.sources,
    map = tree.map;
  var rootNames = map.names;
  var rootMappings = (0, _traceMapping.decodedMappings)(map);
...
function originalPositionFor(source, line, column, name) {
  ...
  var segment = (0, _traceMapping.traceSegment)(source.map, line, column);
...
function buildSourceMapTree(input, loader) {
  var maps = asArray(input).map(function (m) {
    return new _traceMapping.TraceMap(m, '');
  });
  var map = maps.pop();
...
var SourceMap = /*#__PURE__*/function () {
  function SourceMap(map, options) {
    ...
    var out = options.decodedMappings ? (0, _genMapping.toDecodedMap)(map) : (0, _genMapping.toEncodedMap)(map);
